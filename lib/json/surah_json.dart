...
List<Map<String, dynamic>> allJsonSurah = [
  {
    "id": 1,
    "name": "الفاتحة",
...
// Returning an objects of all the quran surah
List<Surah> loadingAllSurah() {
  List<Surah> allSurah = [];

  for (int x = 0; x < allJsonSurah.length; x++) {

    allSurah.add(
      Surah(
        id: allJsonSurah[x]["id"],
        name: allJsonSurah[x]["name"],
        transliteration: allJsonSurah[x]["transliteration"],
        translation: allJsonSurah[x]["translation"],
        type: allJsonSurah[x]["type"],
        totalVerses: allJsonSurah[x]["total_verses"],
      ),
    );
  }
